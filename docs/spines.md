...
#0, journal/0124) at the FAR site only.** *The two words are kept apart on
...
(journal/0124): `surface_class` calls `sample_dithered` over a
...
both costs.
**⚠ SETTLED UNEVENLY, 2026-07-29 (E5 member #0, journal/0124) — one of the three
