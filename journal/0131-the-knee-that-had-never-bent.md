...
> `journal/0131` and will need the number substituted.
...
corrections #77, written the same session, is about the integrator's own error: a
...
corrections #77, demonstrated on the very next slice that cited it.
